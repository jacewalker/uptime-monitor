...
class UptimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create uptime" do
    assert_difference("Uptime.count") do
      post uptimes_url, params: { uptime: { cancelled: @uptime.cancelled, host: @uptime.host, interval: @uptime.interval } }
    end
  ...
  test "should update uptime" do
    patch uptime_url(@uptime), params: { uptime: { cancelled: @uptime.cancelled, host: @uptime.host, interval: @uptime.interval } }
